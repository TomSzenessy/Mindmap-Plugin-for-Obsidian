...
var MarkdownMindMapModal = class extends import_obsidian5.Modal {
...
var CanvasMindMapPlugin = class extends import_obsidian5.Plugin {
	...
	async createNewMindMap(targetFolder) {
		...
		const currentCanvas = this.canvasApi?.getActiveCanvas?.();
		if (currentCanvas) {
			try {
				await flushCanvasView(currentCanvas, this.app.vault);
			} catch (_) {}
		}
